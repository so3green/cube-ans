...
int turn_Ty_minus(){
    ...
    cube[4][1]=cube_save[0][1];
    cube[4][3]=cube_save[0][3];
    cube[0][1]=cube_save[5][1];
    cube[0][3]=cube_save[5][3];
    cube[5][1]=cube_save[2][2];
    cube[5][3]=cube_save[2][0];
    cube[2][2]=cube_save[4][1];
    cube[2][0]=cube_save[4][3];
